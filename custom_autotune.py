...
class Autotuner(triton.KernelInterface):
	...
	def _bench(self, *args, config, **meta):
		...
		# except triton.compiler.OutOfResources:
			...
			return float('inf')
		'''
		out of resource: shared memory, Required: 69632, Hardware limit: 65536. Reducing block sizes or `num_stages` may help.
		加大共享内存
		'''
	...
	def run(self, *args, **kwargs):
		...
		if len(self.configs) > 1:
			...
			if key not in self.cache:
				...
				{<triton.runtime.autotuner.Config object at 0x7f3f1253fd00>: inf,    ---> line 73
				<triton.runtime.autotuner.Config object at 0x7f3f1253fc70>: (18.767616271972656, 18.74812889099121, 18.7871036529541), ....... 
				'''
