...
parser.add_argument("--model_path", default=None, type=str, help="The path of base model.")
...
parser.add_argument("--is_save_frep", default="no", type=str, help="no or save")
...
#                         # level=logging.DEBUG,
#                         level=logging.INFO,
#                         filename='/home/log/train_lora.log',   # docker容器里位置
...
def main():
    ...
    print('train run time: {:.0f}分 {:.0f}秒'.format((time.time() - start_time) // 60, (time.time() - start_time) % 60))
    print('********** running training end **********')
    print('\n')
    print('\n')
    print('\n')
